#MOHD SHAFIZAN BIN ABDULLAH (20DDT21F1043)
#NAQIU NAQAYYOUM BIN KAMIS (2ODDT21F1011)
#MUHAMAD IRFAN BIN MOHAMAD IKHWAN (20DDT21F1030)
...
studidLabel = Label(root, text="ID", font=('Arial', 15))
...
addBtn = Button(
    root, text="Add", padx=30, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#84F894", command=add)
updateBtn = Button(
    root, text="Update", padx=30, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#84E8F8", command=update)
deleteBtn = Button(
    root, text="Delete", padx=30, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#FF9999", command=delete)
searchBtn = Button(
    root, text="Search", padx=30, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#F4FE82", command=search)
resetBtn = Button(
    root, text="Reset", padx=30, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#F398FF", command=reset)
selectBtn = Button(
    root, text="Select", padx=30, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#EEEEEE", command=select)
clearbtn = Button(
    root, text="Clear", padx=30, pady=15, width=10,
